...
def GetArgs():
    ...
    parser.add_argument("--out_dir", type=str, help="Output record data directory", default="")
    ...
    for i in range(start_index, num_replicas+1):
        for recording_id in keys:
            ...
            if reverberate_opts == "" or i == 0:
                ...
                wav_corrupted_pipe = "{0} wav-reverberate --shift-output={1} {2} - {3}/{4}_rvb.wav".format(wav_original_pipe, shift_output, reverberate_opts, out_dir, recording_id)
...
def CreateReverberatedCopy(input_dir,
    ...
    GenerateReverberatedWavScp(wav_scp, durations, output_dir, room_dict, pointsource_noise_list, iso_noise_dict,
               ...
               pointsource_noise_addition_probability, max_noises_per_minute, out_dir)
